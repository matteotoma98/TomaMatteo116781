...
public class GenericDirection implements Direction<Integer> {
     ...
     */
    public GenericDirection(int angle) {
        checkAngle(angle);
        this.angle = angle;
    }
    ...
    public boolean equals(Object o) {
        ...
        GenericDirection that = (GenericDirection) o;
